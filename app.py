...
def app2():
    ...
    if st.session_state['reviews_data'] is not None:
        ...
        # Enhanced classify_review function with more keywords
        def classify_review(review):
            process_keywords = [
                ...
                'experience', 'communication', 'clarity', 'process flow', 'quality assurance'
            ]
            technology_keywords = [
                ...
                'hard-to-use', 'malfunction', 'fail', 'downtime', 'integration', 'updates', 'technical support'
            ]
            people_keywords = [
        ...
        # Enhanced categorize_review function with more keywords
